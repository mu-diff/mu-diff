...
% -------------------------------------------------------------------------
% U = ExternalDoubleLayerPotential(X, Y, N_scat, O, a, k, M_modes, Density, Weight)
%
...
%
%
% See also InternalDoubleLayerPotential, ExternalPotential, InternalPotential

function U = ExternalDoubleLayerPotential(X, Y, O, a, M_modes, k, Density, Weight, varargin)
