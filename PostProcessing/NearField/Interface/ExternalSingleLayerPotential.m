...
% -------------------------------------------------------------------------
% Note: the computation is done OUTSIDE the obstacles and the returned 
% variable U has 0 value inside the obstacles.
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
% U = ExternalSingleLayerPotential(X, Y, N_scat, O, a, k, M_modes, Density, Weight)
%
...
%
%
% See also InternalSingleLayerPotential, ExternalPotential, InternalPotential

function U = ExternalSingleLayerPotential(X, Y, O, a, M_modes, k, Density, Weight, varargin)
    ...
    U = ExternalPotential(X, Y, O, a, M_modes, k, Density, TypeOfOp, varargin{:});
end